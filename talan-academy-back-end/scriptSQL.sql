...
INSERT INTO application VALUES (nextval('application_id_seq'),'mohamed','2022-12-25','mohamed',CURRENT_TIMESTAMP ,'passable','cv1.pdf','ENGINEER',1,true,'oui tres motivee','SITUATION_WORKER','CIVIL','ACCEPTED',1,101);
INSERT INTO application VALUES (nextval('application_id_seq'),'moahmed','2022-10-22','mohamed',CURRENT_TIMESTAMP ,'bien','cv2.pdf','DOCTORATE',5,false,'oui  motivee','SITUATION_SEARCHING','ELECTRIQUE','WITHDRAWAL',2,101);
INSERT INTO application VALUES (nextval('application_id_seq'),'mohamed','2022-09-13','mohamed',CURRENT_TIMESTAMP ,'à revoir','cv3.pdf','OTHER',3,true,'pas motivee','SITUATION_WORKER','MECHANICAL','CANCELLED',1,101);

INSERT INTO application VALUES (nextval('application_id_seq'),'mohamed','2022-05-21','mohamed',CURRENT_TIMESTAMP ,'passable','cv4.pdf','ENGINEER',4,true,'oui tres motivee','SITUATION_SEARCHING','ARCHITECTURE','NEW',2,101);
INSERT INTO application VALUES (nextval('application_id_seq'),'moahmed','2022-12-01','mohamed',CURRENT_TIMESTAMP ,'bien','cv5.pdf','OTHER',0,false,'tres motivee','SITUATION_SEARCHING','ENERGY','REFUSED',2,101);
INSERT INTO application VALUES (nextval('application_id_seq'),'mohamed','2022-01-03','mohamed',CURRENT_TIMESTAMP ,'à revoir','cv6.pdf','OTHER',7,false,'pas motivee','SITUATION_WORKER','AUTOMATIC','INPROGRESS',1,101);

INSERT INTO application VALUES (nextval('application_id_seq'),'mohamed','2021-12-19','mohamed',CURRENT_TIMESTAMP ,'passable','cv7.pdf','ENGINEER',7,false,'ps de motivation','SITUATION_SEARCHING','HYDRAULICS','ABANDONED',2,101);
INSERT INTO application VALUES (nextval('application_id_seq'),'moahmed','2023-11-25','mohamed',CURRENT_TIMESTAMP ,'tres bien','cv8.pdf','DOCTORATE',6,false,'pas de motivation','SITUATION_WORKER','OTHER','ABANDONED',1,101);
